...
{
  "devices": [
    {"id": "BUYER_DEVICE_ID", "name": "Buyer 1", "active": true}
  ]
}

Remove an entry or set active to false to revoke access, then redeploy. If the
buyer clears app/browser data, a new Device ID is generated and must be added.
